...
import com.goldmansachs.kata2go.antlr.JavaListener;
...
public abstract class AbstractJavaListener implements JavaListener
{
    @Override
    ...
    @Override
    public void enterTypeType(@NotNull JavaParser.TypeTypeContext ctx)
    {

    }

    @Override
    public void exitTypeType(@NotNull JavaParser.TypeTypeContext ctx)
    {
